...
def draw_lines(img, lines, color=[255, 0, 0], thickness=2):
    ...
    if (len(left_x_points) == 0) | (len(right_x_points) == 0):
        return

    min_index = left_x_points.index(min(left_x_points))
    max_index = left_x_points.index(max(left_x_points))
    left_slope = (left_y_points[max_index] - left_y_points[min_index]) / (left_x_points[max_index] - left_x_points[min_index])
    # print('left_slope: ', left_slope)
    left_top_y = 330
    left_top_x = int((left_top_y - left_y_points[max_index]) / left_slope + left_x_points[max_index])
    left_bottom_y = 539
    left_bottom_x = int((left_bottom_y - left_y_points[max_index]) / left_slope + left_x_points[max_index])
    ...
    right_slope = (right_y_points[max_index] - right_y_points[min_index]) / (right_x_points[max_index] - right_x_points[min_index])
    # print('right_slope: ', right_slope)
    right_top_y = 330
    right_top_x = int((right_top_y - right_y_points[max_index]) / right_slope + right_x_points[max_index])
    right_bottom_y = 539
    right_bottom_x = int((right_bottom_y - right_y_points[max_index]) / right_slope + right_x_points[max_index])
